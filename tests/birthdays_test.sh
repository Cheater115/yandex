...
FILE1='birthdays/good_data_send1.json'
FILE2='birthdays/good_data_send3.json'
FILE3='birthdays/good_data_send10.json'

FILE1_E='birthdays/good_data_expect1.json'
FILE2_E='birthdays/good_data_expect3.json'
FILE3_E='birthdays/good_data_expect10.json'


# @params:
#   $1: Файл с json даными для отправки
#   $2: Файл с json данными для сравнения
test_add_citizen()
{
    site=$SITE
    ...
    site='http://127.0.0.1:8080/imports/'$import_id'/citizens/birthdays'
    echo "Получение данных о днях рождения с $site"
...
show_results()
{
    echo "Результаты тестирования birthdays:"
